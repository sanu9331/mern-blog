    ...
    return (
        <Navbar className='border-b-2 bg-gray-100'>
            ...
            <Navbar.Collapse className=' p-2 lg:flex lg:items-center lg:justify-end'>
                {/* <Navbar.Link as={Link} to="/" active={path === "/"}>Home</Navbar.Link>
                <Navbar.Link as={Link} to="/about" active={path === "/about"}>About</Navbar.Link>
                <Navbar.Link as={Link} to="/projects" active={path === "/projects"}>Projects</Navbar.Link> */}
                <Navbar.Link
                    as={Link}
                    to="/"
